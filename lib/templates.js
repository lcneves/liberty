...
;pug_debug_line = 2;pug_debug_filename = "views\u002Fincludes\u002Ffooter.pug";
pug_html = pug_html + "2017 Lucas Neves\u003C\u002FCopyright\u003E\u003C\u002Fdiv\u003E\u003C\u002Fsurface\u003E";}.call(this,"user" in locals_for_with?locals_for_with.user:typeof user!=="undefined"?user:undefined));} catch (err) {pug.rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;};
